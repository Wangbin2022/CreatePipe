...
namespace CreatePipe
{
    ...
    //        //List<string> routeNames = new List<string>() { "吊挂标识", "附着标识", "立柱" };
    //        //UniversalComboBoxSelection subView = new UniversalComboBoxSelection(routeNames, "选择标记种类", onSelected);
    //        //subView.ShowDialog();
    ...
    //        //Family familyDoc = tagSymbol.Family;

    //        ////TaskDialog.Show("tt", tagSymbol.FamilyName);
    //        ////Document familyDoc = tagSymbol.Family.Document;
    //        //FamilyManager fm = familyDoc.FamilyManager;
    //        //FamilyParameter familyParam = fm.get_Parameter("TAG_SAMPLE_TEXT");

    //        //if (familyParam != null && familyParam.StorageType == StorageType.String)
    //        //{
    //        //    string sampleText = fm.CurrentType.AsString(familyParam);
    //        //    TaskDialog.Show("TAG_SAMPLE_TEXT", sampleText);
    //        //}

    //        //Parameter param = tag.get_Parameter(BuiltInParameter.TAG_SAMPLE_TEXT);
    //        //TaskDialog.Show("tt", param.AsString());
    ...
    //        ////string content= family.LookupParameter("标识内容").AsString();
    //        ////TaskDialog.Show("tt", content);
    //        //////
