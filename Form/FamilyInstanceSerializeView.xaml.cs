    ...
    public class FamilyInstanceSerializeViewModel : ObserverableObject
    {
        ...
        private void ToggleSelectionMode(object obj)
        {
            _externalHandler.Run(app =>
            {
                ...
                {
                    TaskDialog.Show("tt", $" 参数'{InstanceAttr}'可能是系统内置参数，请注意");
                    //return;
                }
        ...
        private bool IsBuiltInParameter(string parameterName)
        {
            ...
            // 尝试看看字符串是否匹配 BuiltInParameter 的枚举定义名
            return Enum.TryParse(parameterName, out BuiltInParameter result);
        }
        ...
        public string CodePreview => $"{BeforeCode}{SerialCode}{BackCode}";
        ...
        //}
        public string BeforeCode { get => _beforeCode; set { _beforeCode = value; OnPropertyChanged(nameof(CodePreview)); } }
        private string _beforeCode = "";
        public string BackCode { get => _backCode; set { _backCode = value; OnPropertyChanged(nameof(CodePreview)); } }
        private string _backCode = "";
        public int SerialCode { get => _serialCode; set { _serialCode = value; OnPropertyChanged(nameof(CodePreview)); } }
        ...
        public bool IsSelectionMode { get => _isSelectionMode; set => SetProperty(ref _isSelectionMode, value); }
